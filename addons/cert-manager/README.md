...
```bash
$ kubectl apply -f https://github.com/jetstack/cert-manager/releases/download/v1.4.0-alpha.0/cert-manager.crds.yaml
```
...
```console
$ kubectl delete -f https://github.com/jetstack/cert-manager/releases/download/v1.4.0-alpha.0/cert-manager.crds.yaml
```
...
| `image.tag` | Image tag | `v1.4.0-alpha.0` |
...
| `webhook.image.tag` | Webhook image tag | `v1.4.0-alpha.0` |
...
| `cainjector.image.tag` | cainjector image tag | `v1.4.0-alpha.0` |
