...
{{- define "ack-sfn-controller.app.name" -}}
...
*/}}
{{- define "ack-sfn-controller.app.fullname" -}}
...
{{- define "ack-sfn-controller.chart.name-version" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/* The name of the service account to use */}}
{{- define "ack-sfn-controller.service-account.name" -}}
...
{{- define "ack-sfn-controller.aws.credentials.secret_mount_path" -}}
{{- "/var/run/secrets/aws" -}}
{{- end -}}

{{/* The path the shared credentials file is mounted */}}
{{- define "ack-sfn-controller.aws.credentials.path" -}}
{{ $secret_mount_path := include "ack-sfn-controller.aws.credentials.secret_mount_path" . }}
{{- printf "%s/%s" $secret_mount_path .Values.aws.credentials.secretKey -}}
{{- end -}}

{{/* The rules a of ClusterRole or Role */}}
{{- define "ack-sfn-controller.rbac-rules" -}}
rules:
- apiGroups:
  - ""
  resources:
...
{{- define "ack-sfn-controller.feature-gates" -}}
{{- $list := list -}}
