...
{{- define "ack-ecr-controller.app.name" -}}
...
*/}}
{{- define "ack-ecr-controller.app.fullname" -}}
...
{{- define "ack-ecr-controller.chart.name-version" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/* The name of the service account to use */}}
{{- define "ack-ecr-controller.service-account.name" -}}
    {{ default "default" .Values.serviceAccount.name }}
{{- end -}}

{{- define "ack-ecr-controller.watch-namespace" -}}
...
{{- define "ack-ecr-controller.aws.credentials.secret_mount_path" -}}
{{- "/var/run/secrets/aws" -}}
{{- end -}}

{{/* The path the shared credentials file is mounted */}}
{{- define "ack-ecr-controller.aws.credentials.path" -}}
{{ $secret_mount_path := include "ack-ecr-controller.aws.credentials.secret_mount_path" . }}
{{- printf "%s/%s" $secret_mount_path .Values.aws.credentials.secretKey -}}
{{- end -}}

{{/* The rules a of ClusterRole or Role */}}
{{- define "ack-ecr-controller.rbac-rules" -}}
rules:
- apiGroups:
  - ""
  resources:
...
{{- define "ack-ecr-controller.feature-gates" -}}
{{- $list := list -}}
