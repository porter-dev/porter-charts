...
{{- define "ack-cloudwatch-controller.app.name" -}}
...
*/}}
{{- define "ack-cloudwatch-controller.app.fullname" -}}
...
{{- define "ack-cloudwatch-controller.chart.name-version" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/* The name of the service account to use */}}
{{- define "ack-cloudwatch-controller.service-account.name" -}}
    {{ default "default" .Values.serviceAccount.name }}
{{- end -}}

{{- define "ack-cloudwatch-controller.watch-namespace" -}}
...
{{- define "ack-cloudwatch-controller.aws.credentials.secret_mount_path" -}}
{{- "/var/run/secrets/aws" -}}
{{- end -}}
...
{{- define "ack-cloudwatch-controller.rbac-rules" -}}
rules:
- apiGroups:
  - ""
  resources:
