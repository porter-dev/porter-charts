...
{{- define "ack-dynamodb-controller.app.name" -}}
...
*/}}
{{- define "ack-dynamodb-controller.app.fullname" -}}
...
{{- define "ack-dynamodb-controller.chart.name-version" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/* The name of the service account to use */}}
{{- define "ack-dynamodb-controller.service-account.name" -}}
...
{{- define "ack-dynamodb-controller.aws.credentials.secret_mount_path" -}}
{{- "/var/run/secrets/aws" -}}
{{- end -}}
...
{{- define "ack-dynamodb-controller.rbac-rules" -}}
rules:
- apiGroups:
  - ""
  resources:
...
{{- define "ack-dynamodb-controller.feature-gates" -}}
{{- $list := list -}}
