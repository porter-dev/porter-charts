...
{{- define "ack-cloudtrail-controller.app.name" -}}
...
*/}}
{{- define "ack-cloudtrail-controller.app.fullname" -}}
...
{{- define "ack-cloudtrail-controller.chart.name-version" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/* The name of the service account to use */}}
{{- define "ack-cloudtrail-controller.service-account.name" -}}
...
{{- define "ack-cloudtrail-controller.aws.credentials.secret_mount_path" -}}
{{- "/var/run/secrets/aws" -}}
{{- end -}}

{{/* The path the shared credentials file is mounted */}}
{{- define "ack-cloudtrail-controller.aws.credentials.path" -}}
{{ $secret_mount_path := include "ack-cloudtrail-controller.aws.credentials.secret_mount_path" . }}
{{- printf "%s/%s" $secret_mount_path .Values.aws.credentials.secretKey -}}
{{- end -}}

{{/* The rules a of ClusterRole or Role */}}
{{- define "ack-cloudtrail-controller.rbac-rules" -}}
rules:
- apiGroups:
  - ""
  resources:
...
{{- define "ack-cloudtrail-controller.feature-gates" -}}
{{- $list := list -}}
